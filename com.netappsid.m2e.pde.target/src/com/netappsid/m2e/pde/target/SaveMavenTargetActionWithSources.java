...
public class SaveMavenTargetActionWithSources extends LoadMavenTargetAction
{
	@Override
	protected void run(MavenPDETarget mavenPDETarget, MavenBundleContainer mavenBundleContainer)
	{
		...
		ITargetDefinition newTarget = mavenPDETarget.saveMavenTargetDefinition(getShell(), elements.get(0), mavenBundleContainer, true);
	}
}
